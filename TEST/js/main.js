...
let masNum = [3, 2, 4, 3, 3, 2, 2, 2, 3, 3];
...
let masTex = ['Сонячне світло', 'CO2 та сонячне світло', 'Речовини, що містяться в рослинах та тваринах', 'Розкладають мертві організми, випускаючи CO2', 'Мертві організми та відходи', 'Органічний вуглець, що можна спалити для випуску CO2', 'Дихання', 'Дихання', 'Автомобілі та заводські викиди', 'Цикл CO2']
